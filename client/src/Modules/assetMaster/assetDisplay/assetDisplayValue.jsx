...
const staticFieldClass =
  'w-full max-w-64 px-2.5 py-1.5 rounded text-[clamp(0.72rem,0.55rem+0.6vw,1rem)] border border-slate-200 bg-slate-50 text-slate-500';
      ...
      <div className={sectionCardClass}>
        ...
        */}
        <div className='grid grid-cols-[minmax(10rem,14rem)_minmax(15rem,1fr)] min-w-0 mt-2 mb-8 mr-5 gap-y-3 gap-x-2 text-[clamp(0.72rem,0.55rem+0.6vw,1rem)] pr-8'>
          ...
          <span className='p-2 text-[clamp(0.72rem,0.55rem+0.6vw,1rem)] text-gray-500'> Acquisition - by Purchase</span>
